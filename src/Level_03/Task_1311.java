...
/**
 * Title - Нанимаем переводчика # 1311.
 * @task 1. Создать класс EnglishTranslator, который наследуется от Translator.
 * 2. Реализовать все абстрактные методы.
 * 3. Подумай, что должен возвращать метод getLanguage.
 * 4. Программа должна выводить на экран "Я переводчик с английского" путем вызова метода translate
