...
/**
 * Title - Это кто там такой умный? # 1310.
 * @task 1. Добавь интерфейсы Secretary и Boss к классам Manager и Subordinate. По одному на каждый. Подумай, кому какой.
...
public class Task_1310 {
    ...
    abstract class Subordinate implements Secretary {
        public void use(Person person) {}
