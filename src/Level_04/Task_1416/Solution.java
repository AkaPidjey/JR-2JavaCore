package Level_04.Task_1416;

/**
 * Title - Исправление ошибок # 1416.
 * @task 1. Подумай, как связаны интерфейсы Swimmable(способен плавать) и Walkable(способен ходить)
...
public class Solution {
    ...
    static abstract class OceanAnimal implements Walkable, Swimmable {
        public void swim() {
