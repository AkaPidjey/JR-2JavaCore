package Level_04.Task_1409;

/**
 * Title - Мосты # 1409.
 * @task 1. Создать интерфейс Bridge с методом int getCarsCount().
 ...
 * •	Метод println должен выводить на консоль количество машин(результат работы метода getCarsCount)
