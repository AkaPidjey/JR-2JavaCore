package Level_04.Task_1413;

/**
 * Title - Computer # 1413.
 * @task 1. Создай интерфейс CompItem.
 ...
 * •	Метод getName в классах реализующих интерфейс CompItem должен возвращать простое имя класса, например "Keyboard"
 * для класса Keyboard.
 * •	Класс Computer должен содержать по одному приватному полю типа Keyboard, Mouse, Monitor, а также существовать
 * в отдельном файле.
 * •	Конструктор класса Computer должен принимать 3 параметра(keyboard, mouse, monitor) и корректно инициализировать
 * соответствующие поля класса.
 * •	Для полей keyboard, mouse и monitor Computer должны быть созданы геттеры(getKeyboard, getMouse, getMonitor),
