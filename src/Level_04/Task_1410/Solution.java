package Level_04.Task_1410;

/**
 * Title - Дегустация вин # 1410.
 * @task 1. Создать абстрактный класс Drink с реализованным методом public void taste(), который выводит в консоль "Вкусно".
