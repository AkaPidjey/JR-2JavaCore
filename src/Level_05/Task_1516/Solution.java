package Level_05.Task_1516;

/**
 * Title - Значения по умолчанию # 1516.
 * @task 1. Создать 7 public полей класса. Убедитесь, что они инициализируются дефолтными значениями.
 * intVar типа int
