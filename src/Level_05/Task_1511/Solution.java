package Level_05.Task_1511;

import java.io.Serializable;

/**
 * Title - Максимально простой код-1 # 1511.
 * @task Упрости код - убери все наследования и реализации, которые и так будут добавлены автоматически при компиляции
