package Level_05.Task_1521;

import java.math.BigDecimal;

/**
 * Title - ООП. Перегрузка # 1521.
 * @task 1. В классе Tree перегрузи метод info(Object s) два раза так, чтобы получилось три метода info(Object s),
