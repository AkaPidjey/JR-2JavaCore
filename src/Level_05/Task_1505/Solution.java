package Level_05.Task_1505;

import java.util.ArrayList;
import java.util.List;

/**
 * Title - ООП - исправь ошибки в наследовании # 1505.
 * @task Исправь метод containsBones и всю связанную с ним логику так, чтобы:
 ...
 * •	Метод containsBones в классе Finger должен возвращать строку "Yes", если метод containsBones в классе
 * BodyPart возвращает "Yes" и флаг isArtificial равен false, если приведенное условие не выполняется - вернуть "No".
 * •	Метод toString в классе BodyPart должен возвращать строку формата "name(имя части тела) содержит кости",
...
public class Solution {
    public static interface LivingPart { Object containsBones();}
