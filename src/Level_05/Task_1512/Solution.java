package Level_05.Task_1512;

/**
 * Title - Максимально простой код-2 # 1512.
 * @task Посмотри, что, связанное с конструкторами, может быть добавлено при компиляции, но в этой программе уже присутствует.
